      ...
      <div className="navbar max-w-11/12 md:max-w-10/11 mx-auto px-0">
        ...
        <div className="lg:hidden ml-2">
          <button
            ...
            className="btn btn-primary btn-xs py-4"
          >
            {menuOpen ? <X /> : <Menu />}
          </button>
        </div>
        ...
        {/* Mobile Dropdown */}
        {menuOpen && (
          <div className="absolute top-full left-0 w-full bg-base-100 p-4 flex flex-col items-center shadow-md lg:hidden z-40 min-h-screen">
            {navItems}
            <div className="mt-2">
              {user ? (
